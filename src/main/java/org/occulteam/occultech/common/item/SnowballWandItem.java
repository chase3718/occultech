...
// pLevel.addParticle(ParticleTypes.ITEM_SNOWBALL, pPlayer.getX(),
// pPlayer.getY(), pPlayer.getZ(), 0.0D, 0.0D,
// 0.0D);

// // Shoot a snowball out of the wand
// Vec3 look = pPlayer.getLookAngle();
// Snowball snowball = new Snowball(pLevel, pPlayer);
// snowball.setPos(pPlayer.getX() + look.x, pPlayer.getY() + look.y +
// pPlayer.getEyeHeight(),
// pPlayer.getZ() + look.z);
// snowball.setOwner(pPlayer);
// snowball.shootFromRotation(pPlayer, pPlayer.getXRot(), pPlayer.getYRot(),
// 0.0F, 1.5F, 1.0F);
