...
public class FireballWandItem extends WandItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        // Play a sound
        pLevel.playSound(null, pPlayer.getX(), pPlayer.getY(), pPlayer.getZ(), SoundEvents.BLAZE_SHOOT,
                SoundSource.PLAYERS, 1.0F, 1.0F);

        // Play a particle effect
        pLevel.addParticle(ParticleTypes.FLAME, pPlayer.getX(), pPlayer.getY(), pPlayer.getZ(), 0.0D, 0.0D, 0.0D);
